...
class _CME2PageState extends State<CME2Page> {
  ...
  final String _qrData = 'app://setor/cme2'; // QR code fixo para deep link CME 2
  ...
  void _loadCompletionStatus() {
    _databaseReference.child('setores/cme2/finalizado').once().then((DatabaseEvent event) {
      if (event.snapshot.exists) {
        setState(() {
