...
class _GeralArea3PageState extends State<GeralArea3Page> {
  ...
  final String _qrData = 'app://setor/geral_area3'; // QR code fixo para deep link Geral Área 3
  ...
  void _loadCompletionStatus() {
    _databaseReference.child('setores/geral_area3/finalizado').once().then((DatabaseEvent event) {
      if (event.snapshot.exists) {
        setState(() {
  ...
  Future<void> _saveQRCodeAsPDF() async {
    ...
    await Printing.sharePdf(
      ...
      filename: 'qr_code_geral_area3.pdf',
    );
  }
