...
class _GeralArea1PageState extends State<GeralArea1Page> {
  ...
  final String _qrData = 'app://setor/geral_area1'; // QR code fixo para deep link Geral Área 1
  ...
  void _loadCompletionStatus() {
    _databaseReference.child('setores/geral_area1/finalizado').once().then((DatabaseEvent event) {
      if (event.snapshot.exists) {
        setState(() {
  ...
  Future<void> _saveQRCodeAsPDF() async {
    ...
    await Printing.sharePdf(
      ...
      filename: 'qr_code_geral_area1.pdf',
    );
  }
